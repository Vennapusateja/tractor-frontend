  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.hero}>
        {/* <img src="/images/tractor2.png" alt="Tractor" style={styles.heroImage} /> */}
      ...
      {!loading && tractors.length === 0 && (
        <div style={styles.empty}>
          <img src="/images/tractor2.png" alt="No tractors" style={{ width: '160px', borderRadius: '12px', marginBottom: '12px', opacity: 0.7 }} />
