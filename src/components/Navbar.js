          ...
          >
            ...
            {rentalOpen && (
              <div style={styles.dropdownMenu}>
                ...
                <Link to="/tractors"    style={styles.dropdownItem} onClick={closeAll}>🚜 Browse Tractors for Rent</Link>
                <Link to="/bookings"    style={styles.dropdownItem} onClick={closeAll}>📋 My Bookings</Link>
                <div style={styles.dropdownDivider} />
                <div style={styles.dropdownHeader}>For Owners</div>
                <Link to="/add-tractor" style={styles.dropdownItem} onClick={closeAll}>➕ List My Tractor for Rent</Link>
                <Link to="/dashboard"   style={styles.dropdownItem} onClick={closeAll}>🛠 Manage Bookings</Link>
              </div>
            )}
          </div>
          ...
          >
            ...
            {buyingOpen && (
              <div style={styles.dropdownMenu}>
                ...
                <Link to="/buy-tractors" style={styles.dropdownItem} onClick={closeAll}>🔍 Browse Tractors for Sale</Link>
                <Link to="/equipment"    style={styles.dropdownItem} onClick={closeAll}>🔧 Browse Equipment</Link>
                <div style={styles.dropdownDivider} />
                <div style={styles.dropdownHeader}>For Sellers</div>
                <Link to="/add-tractor"  style={styles.dropdownItem} onClick={closeAll}>➕ List Tractor for Sale</Link>
                <Link to="/dashboard"    style={styles.dropdownItem} onClick={closeAll}>📊 My Listings</Link>
              </div>
            )}
          </div>
        </div>
